...
from dsrna_worst_case_pipeline_v2.commands.align_sequences import align, internal_msa_plot
from dsrna_worst_case_pipeline_v2.commands.pairwise_align import pairwise, internal_pairwise_run
from dsrna_worst_case_pipeline_v2.commands.calculate_accessibility import accessibility, internal_accessibility_run
from dsrna_worst_case_pipeline_v2.commands.bowtie_match import bowtie, internal_bowtie_run
...
app.command(name="align")(align)
app.command(name="pairwise")(pairwise)
app.command(name="accessibility")(accessibility)
app.command(name="bowtie")(bowtie)
